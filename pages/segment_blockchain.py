...
dash.register_page(__name__, path='/blockchain')
logger = LoraLogger.logger(__name__, INFO)
data_df = pd.read_excel('../utils/FAI_results.xlsx')

segment_column = '15. Have you ever traded cryptocurrency?'
...
layout = html.Div(children=[
    ...
    dcc.Loading(
        id="bc-loading",
        children=[html.Div(id='fig_bc', style={
...
@callback(
    Output(component_id='fig_bc', component_property='children'),
    [
