...
dash.register_page(__name__, path='/digital_insurance')
logger = LoraLogger.logger(__name__, INFO)
data_df = pd.read_excel('../utils/FAI_results.xlsx')

segment_column = '13. Have you ever used digital insurance?'
...
layout = html.Div(children=[
    ...
    dcc.Loading(
        id="di-loading",
        children=[html.Div(id='fig_di', style={
...
@callback(
    Output(component_id='fig_di', component_property='children'),
    [
