...
dash.register_page(__name__, path='/virtual_banking')
logger = LoraLogger.logger(__name__, INFO)
data_df = pd.read_excel('../utils/FAI_results.xlsx')

segment_column = '7. Do you have a virtual bank account?'
...
layout = html.Div(children=[
    ...
    dcc.Loading(
        id="vb-loading",
        children=[html.Div(id='fig_vb', style={
...
@callback(
    Output(component_id='fig_vb', component_property='children'),
    [
